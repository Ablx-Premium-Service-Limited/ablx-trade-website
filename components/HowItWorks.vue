        ...
        <div class="space-y-8">
          ...
          <div class="flex gap-6 group hover:transform hover:scale-105 transition-all duration-300">
            <div class="flex-shrink-0">
              <div
                class="w-16 h-16 rounded-2xl gradient-bg flex items-center justify-center text-white font-bold text-xl shadow-lg group-hover:shadow-xl transition-shadow">
                1
              </div>
            </div>
            <div class="flex-1">
          ...
          <div class="pt-6">
            <button
              class="text-white gradient-bg px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              Start Trading Now
            </button>
          </div>
        </div>
        ...
        <div class="relative">
          ...
          <div class="relative z-10">
            <div class="relative">
              ...
              <img src="/photo-1517841905240-472988babdf9.png" alt="Happy person using ABLX Trade app on smartphone"
