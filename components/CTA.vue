<template>
  <section class="py-16 gradient-bg text-white" id="hero">
    <div class="container mx-auto px-4 text-center">
      <h2 class="text-3xl md:text-4xl font-bold mb-6 fade-in" ref="title">Ready to Transform Your Financial Experience?
      </h2>
      <p class="text-xl mb-8 max-w-2xl mx-auto fade-in" ref="subtitle">Join thousands of users who are already enjoying
        seamless financial transactions with ABLX</p>
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      if (buttons.value) observer.observe(buttons.value)
    })
